...
// estimation basee sur le nb de pieces, l'occupation, la defense du roi
int estim2(  struct config *conf )
{
	...
	Score = (4*ScrQte + ScrDisp + ScrDfs) * 100.0/(4*76+42+8+24);
	// pour les poids des pi�ces et le facteur multiplicatif voir commentaire dans estim1
...
// Combinaison finale des fonctions d'estimations
int estim6( struct config *conf )
{
